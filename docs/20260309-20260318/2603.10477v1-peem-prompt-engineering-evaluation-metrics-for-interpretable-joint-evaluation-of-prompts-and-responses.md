...
tags: ["query:bopl"]
score: 7.0
evidence: 提示工程的可解释性评估
tldr: 针对大语言模型提示词评估仅关注结果准确性而缺乏可解释性的问题，本文提出PEEM框架。该框架通过9个维度（3个提示词维度和6个响应维度）对提示词和模型回复进行联合评估，利用LLM生成评分及理由。实验表明PEEM与传统指标高度一致，能有效诊断提示词缺陷，并通过反馈循环显著提升下游任务性能，为提示词工程提供了系统化的诊断与优化工具。
selection_source: fresh_fetch
motivation: 现有的提示词评估主要关注答案正确性，难以解释提示词成败的原因，也无法为优化提供具体指导。
method: 提出PEEM框架，定义了涵盖提示词质量和响应质量的9个评估维度，并利用LLM作为评估器输出评分及自然语言解释。
result: PEEM在多个基准测试中与传统准确率高度相关（相关系数约0.97），且其反馈能使零样本提示词重写效果提升高达11.7分。
conclusion: PEEM提供了一种可解释、可复现的联合评估协议，能够有效连接提示词表述与响应行为，助力LLM交互的系统化诊断与优化。
---
